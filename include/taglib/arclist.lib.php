...
<attributes>
    ...
    <iterm>notypeid:同typeid，但这里是表示不包含这些属性</iterm>
    ...
    <iterm>keyword:含有指定关键字的文档列表，多个关键字用","分，可以动态获取当前文章关键字[~keywords~]、标题[~title~]</iterm>
...
function lib_arclist( &$ctag, &$refObj )
{
    ...
    return lib_arclistDone
           (
             $refObj, $ctag, $typeid, $ctag->GetAtt('notypeid'), $ctag->GetAtt('row'), $ctag->GetAtt('col'), $titlelen, $infolen,
 ...
 * @return    string
 */
function lib_arclistDone(&$refObj, &$ctag, $typeid=0, $notypeid=0, $row=10, $col=1, $titlelen=30, $infolen=160,
